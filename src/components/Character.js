...
export default function Character({ character,navigation }) {
    ...
    return (
    <ImageBackground source={require('../images/portal.jpg')} style={styles.character} >
        <TouchableWithoutFeedback 
            onPress={()=>{
        ...
        >
            ...
            <View style = {styles.character}>
                <View style = {styles.spacing}>
                    ...
                    <ImageBackground source={require('../images/computer.png')} style = {styles.character__info} imageStyle={{ borderRadius: 10}}>
